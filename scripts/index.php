...
<style>
@import url('https://fonts.googleapis.com/css2?family=Barlow+Condensed:ital,wght@0,400;0,700;0,900;1,900&family=Barlow:wght@400;500;700&display=swap');
...
/* GTA V Logo */
.gta-logo-wrap { margin-bottom: 10px; }
.gta-logo-img {
    height: 130px;
    width: auto;
...
.split-text p { font-size: 15px; color: #777; line-height: 1.9; margin-bottom: 18px; }
...
.char-card:hover { border-color: #e8291c; transform: translateY(-6px); }
...
.char-info-surname { font-size: 13px; color: #555; margin-top: 2px; }
    ...
    <div class="hero-content">
        ...
        <div class="gta-logo-wrap">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/GTA_V.svg/800px-GTA_V.svg.png"
                 ...
                 class="gta-logo-img"
                 onerror="this.style.display='none'; document.getElementById('gta-fallback').style.display='block'">
            <!-- Fallback falls Logo nicht lädt -->
            <h1 id="gta-fallback" style="display:none; font-size:82px; font-weight:900; line-height:0.9; color:#fff; text-transform:uppercase; letter-spacing:-1px; text-shadow:0 4px 30px rgba(0,0,0,0.8);">
                Grand Theft<br>Auto <span style="color:#e8291c; font-style:italic;">V</span>
            </h1>
        </div>
...
<div class="stats-strip">
    <div class="stat-block">
        ...
        <div class="stat-text">Charaktere</div>
    </div>
    <div class="stat-block">
        <div class="stat-number"><?= $total_weapons ?></div>
        <div class="stat-text">Waffen</div>
    </div>
    <div class="stat-block">
        <div class="stat-number"><?= $total_vehicles ?></div>
        <div class="stat-text">Fahrzeuge</div>
    </div>
    <div class="stat-block">
...
<div class="about-gta">
    <div class="split-layout">
        <div class="split-text">
            ...
            <p>
                <strong>Grand Theft Auto V</strong> ist ein Open-World-Action-Adventure,
                ...
                ist es eines der erfolgreichsten Videospiele aller Zeiten.
            </p>
            <p>
                Das Spiel spielt in der fiktiven Metropole <strong>Los Santos</strong> —
                angelehnt an Los Angeles — sowie in der Wildnis von <strong>Blaine County</strong>.
                Die offene Spielwelt bietet eine nie dagewesene Freiheit und ermöglicht es,
                die Stadt zu erkunden, Missionen zu absolvieren und in die Unterwelt einzutauchen.
            </p>
            <p>
                Das Herzstück des Spiels sind drei spielbare Protagonisten:
                <strong>Michael De Santa</strong>, ein pensionierter Bankräuber,
                <strong>Trevor Philips</strong>, ein berüchtigter Krimineller aus Blaine County,
                und <strong>Franklin Clinton</strong>, ein junger Gangster aus Süd-Los Santos.
            </p>
        </div>
        <div class="img-mosaic">
            <div class="mosaic-img tall">
                <img src="https://www.igta5.com/images/official-screenshot-pc-trevor-cleaning-house.jpg"
                     alt="Trevor" onerror="this.style.display='none'">
            </div>
            <div class="mosaic-img">
                <img src="https://www.igta5.com/images/official-screenshot-pc-franklin-calls-michael.jpg"
                     alt="Franklin" onerror="this.style.display='none'">
            </div>
            <div class="mosaic-img">
                <img src="https://www.igta5.com/images/official-screenshot-pc-michael-on-the-phone.jpg"
                     alt="Michael" onerror="this.style.display='none'">
            </div>
        </div>
    </div>
</div>

<!-- ===== CHARAKTERE (aus der DB, mit echten Bildern) ===== -->
<div class="chars-section">
    ...
    <?php
        ...
        while ($c = mysqli_fetch_assoc($chars)):
            $initials = strtoupper(substr($c['name'],0,1) . substr($c['surname'],0,1));
            $imgUrl   = getCharacterImage($c['name'], $c['surname']);

            if ($c['role'] == 'Main character') $badge = 'badge-main';
            elseif ($c['role'] == 'Protagonist') $badge = 'badge-proto';
            else $badge = 'badge-supp';
    ?>
        <a href="/GTA_Projekt/characters/index.php" class="char-card">
            <div class="char-img-wrap">
                <?php if ($imgUrl): ?>
                    <img src="<?= htmlspecialchars($imgUrl) ?>"
                         alt="<?= htmlspecialchars($c['name'] . ' ' . $c['surname']) ?>"
                         onerror="this.style.display='none'; this.nextElementSibling.style.display='flex'">
                    <div class="char-initials" style="display:none; position:absolute; inset:0;"><?= $initials ?></div>
                <?php else: ?>
                    <div class="char-initials"><?= $initials ?></div>
                <?php endif; ?>
...
<div class="project-section" id="projekt">
    <div class="project-intro">
        ...
        <p>
            Im Rahmen unseres Datenbankprojekts an der Berufsschule haben wir eine vollständige
            relationale Datenbank entwickelt, die auf der Welt von GTA V basiert.
            Ziel war es, die komplexen Beziehungen zwischen Spielelementen —
            Charaktere, Waffen, Fahrzeuge und Locations — strukturiert und
            normalisiert in einer MySQL-Datenbank abzubilden und über ein
            benutzerfreundliches PHP-Interface zugänglich zu machen.
        </p>
    </div>
    <div class="features-grid">
        <div class="feature-item">
            ...
            <p>Die Datenbank erfüllt vollständig die <strong>3. Normalform (3NF)</strong>.
            Alle Daten sind redundanzfrei gespeichert und über Fremdschlüssel korrekt verknüpft.</p>
        </div>
        <div class="feature-item">
            <span class="feature-icon">🔗</span>
            <div class="feature-num">02</div>
            <h3>m:n Beziehungen</h3>
            <p>Charaktere können <strong>mehrere Waffen</strong> besitzen und
            <strong>mehrere Locations</strong> besuchen — abgebildet durch
            Zwischentabellen (<em>Character_Weapons</em>, <em>Character_Locations</em>).</p>
        </div>
        <div class="feature-item">
            <span class="feature-icon">🖥️</span>
            <div class="feature-num">03</div>
            <h3>PHP Webinterface</h3>
            <p>Eine vollständige <strong>CRUD-Oberfläche</strong> in PHP ermöglicht
            das Anzeigen, Hinzufügen, Bearbeiten und Löschen aller Datensätze
            — ohne SQL-Kenntnisse.</p>
        </div>
        <div class="feature-item">
            <span class="feature-icon">⚙️</span>
            ...
            <strong>HTML/CSS</strong>. Als lokaler Webserver wurde
            <strong>XAMPP</strong></p>
        </div>
        <div class="feature-item">
            <span class="feature-icon">👥</span>
            <div class="feature-num">05</div>
            <h3>Zielgruppe</h3>
            <p>Richtet sich an <strong>GTA-Fans</strong> die Spieldaten analysieren wollen,
            <strong>Modder und Entwickler</strong> die strukturierte Infos benötigen,
            sowie <strong>Studierende</strong> die Datenbankdesign lernen.</p>
        </div>
        <div class="feature-item">
            <span class="feature-icon">📋</span>
            ...
            Character_Weapons</strong> und <strong>Character_Locations</strong> —
            alle sauber normalisiert und mit JOIN-Abfragen verknüpft.</p>
        </div>
    </div>
</div>
...
<div class="gallery">
    ...
    <div class="gallery-masonry">
        <div class="gal-item wide">
            <img src="https://www.igta5.com/images/official-screenshot-pc-downtown-dusk.jpg" alt="Downtown LS">
...
<div class="nav-section">
    ...
    <div class="nav-grid">
        ...
        <a href="/GTA_Projekt/weapons/index.php" class="nav-card">
            ...
            <h3>Waffen</h3>
            <p>Pistolen, Gewehre, Schrotflinten, Explosives — das Arsenal von GTA V</p>
            <span class="nav-card-arrow">→</span>
        </a>
